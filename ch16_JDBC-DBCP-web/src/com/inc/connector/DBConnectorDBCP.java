...
public class DBConnectorDBCP {
	private static final String URL = "jdbc:oracle:thin:@localhost:1521:xe";
	private static final String USERNAME = "hr";
	private static final String PASSWORD = "1111";
	private static DBConnectorDBCP single;
	...
	public static DBConnectorDBCP getInstance() {
		if(single == null) {
			single = new DBConnectorDBCP();
		}
		return single;
	}
